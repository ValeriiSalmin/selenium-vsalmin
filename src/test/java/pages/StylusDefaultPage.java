...
//        driver.findElement(By.xpath("//a[@href='http://stylus.com.ua/apple-iphone-6/']")).click();
//    }

//    public void goToIphone6(){
//        driver.findElement(By.xpath("//a[@href='http://stylus.com.ua/apple-iphone-6/']")).click();
...
//        webDriverWait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//a[@href='http://stylus.com.ua/apple-iphone-6/']"))));
//        Actions action = new Actions(driver);
//        action.moveToElement(driver.findElement(By.xpath("//a[@href='http://stylus.com.ua/apple-iphone-6/']"))).click().perform();
